...
def gen_all_strings(word):
    ...
    strings_from_rest_letters = gen_all_strings(rest_letters)
    all_strings = []
    for string in strings_from_rest_letters:
        for index in range(len(string) + 1):
            all_strings.append(string[:index] + first_letter + string[index:])

    return all_strings + gen_all_strings(rest_letters)
